        ...
        <div class="store-locator__column">
            <div class="store-locator__search">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="10.9985" cy="10.7888" r="8.03854" stroke="#737373" stroke-width="1.5"
                            stroke-linecap="square"/>
                    <path d="M16.4873 16.7083L21.0408 21.2499" stroke="#737373" stroke-width="1.5"
                          stroke-linecap="square"/>
                </svg>

                <input type="search" class="store-locator__search-input" placeholder="Search...">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        ...
                        stroke="#737373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M12 4V2" stroke="#737373" stroke-width="1.5" stroke-linecap="square"
                          stroke-linejoin="round"/>
                    <path d="M4 12H2" stroke="#737373" stroke-width="1.5" stroke-linecap="square"
                          stroke-linejoin="round"/>
                    <path d="M12 20V22" stroke="#737373" stroke-width="1.5" stroke-linecap="square"
                          stroke-linejoin="round"/>
                    <path d="M20 12H22" stroke="#737373" stroke-width="1.5" stroke-linecap="square"
                          stroke-linejoin="round"/>
                </svg>
            </div>
